...
func MakeBankSelectorAdminScreen(onBankClick func(int), banksState *state.BanksState) fyne.CanvasObject {
...
func MakeBankAdminCard(onBankClick func(int), bank *model.Bank, index int) fyne.CanvasObject {
	...
	enterprises := container.NewGridWithColumns(1, createAdminEnterpricesConvasList(bank.Enterprises)...)
	...
	rating := container.New(layout.NewCustomPaddedLayout(0, 0, 10, 10), container.NewCenter(createAdminStarRating(bank.Rating)))
...
func createAdminEnterpricesConvasList(enterprises []*model.Enterprise) []fyne.CanvasObject {
...
func createAdminStarRating(count int) fyne.CanvasObject {
